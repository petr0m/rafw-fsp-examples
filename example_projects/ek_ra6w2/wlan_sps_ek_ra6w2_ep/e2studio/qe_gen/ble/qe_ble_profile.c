...
const attribute_t qe_ble_profile[QE_ATTRIBUTE_HANDLE_PROFILE_END] =
{
	...
	[2] =
	{
		...
		.value = (uint8_t []){0x02,0x03,0x00,0x00,0x2A},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[3] =
	{
		...
		.value = (uint8_t []){},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[17] =
	{
		...
		.value = (uint8_t []){0x02,0x12,0x00,0x29,0x2A},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[18] =
	{
		...
		.value = (uint8_t []){0x52,0x65,0x6E,0x65,0x73,0x61,0x73,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[20] =
	{
		...
		.value = (uint8_t []){0x52,0x52,0x51,0x36,0x31,0x78,0x78,0x78,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[36] =
	{
		...
		.value = (uint8_t []){0x30,0x25,0x00,0xB8,0x5C,0x49,0xD2,0x04,0xA3,0x40,0x71,0xA0,0xB5,0x35,0x85,0x3E,0xB0,0x83,0x07},
		.notify_write = 0,
		.notify_read = 0,
		.read_indication = 0,
	...
	[37] =
	{
		...
		.value_length = 0xFB,
		.uuid = (uint8_t []){0xB8,0x5C,0x49,0xD2,0x04,0xA3,0x40,0x71,0xA0,0xB5,0x35,0x85,0x3E,0xB0,0x83,0x07},
		.value = (uint8_t []){},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[39] =
	{
		...
		.value = (uint8_t []){0x53,0x65,0x72,0x76,0x65,0x72,0x20,0x54,0x58,0x20,0x44,0x61,0x74,0x61},
		.notify_write = 0,
		.notify_read = 0,
		.read_indication = 0,
	...
	[40] =
	{
		...
		.value = (uint8_t []){0x0C,0x29,0x00,0xBA,0x5C,0x49,0xD2,0x04,0xA3,0x40,0x71,0xA0,0xB5,0x35,0x85,0x3E,0xB0,0x83,0x07},
		.notify_write = 0,
		.notify_read = 0,
		.read_indication = 0,
	...
	[41] =
	{
		...
		.uuid_length = QE_BLE_PROFILE_UUID_SIZE_CUSTOM,
		.value_length = 0xFB,
		.uuid = (uint8_t []){0xBA,0x5C,0x49,0xD2,0x04,0xA3,0x40,0x71,0xA0,0xB5,0x35,0x85,0x3E,0xB0,0x83,0x07},
		.value = (uint8_t []){},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[42] =
	{
		...
		.value = (uint8_t []){0x53,0x65,0x72,0x76,0x65,0x72,0x20,0x52,0x58,0x20,0x44,0x61,0x74,0x61},
		.notify_write = 0,
		.notify_read = 0,
		.read_indication = 0,
	...
	[43] =
	{
		...
		.value = (uint8_t []){0x16,0x2C,0x00,0xB9,0x5C,0x49,0xD2,0x04,0xA3,0x40,0x71,0xA0,0xB5,0x35,0x85,0x3E,0xB0,0x83,0x07},
		.notify_write = 0,
		.notify_read = 0,
		.read_indication = 0,
	...
	[44] =
	{
		...
		.uuid_length = QE_BLE_PROFILE_UUID_SIZE_CUSTOM,
		.value_length = 0x01,
		.uuid = (uint8_t []){0xB9,0x5C,0x49,0xD2,0x04,0xA3,0x40,0x71,0xA0,0xB5,0x35,0x85,0x3E,0xB0,0x83,0x07},
		.value = (uint8_t []){0x00},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[45] =
	{
		...
		.uuid_length = QE_BLE_PROFILE_UUID_SIZE_ADOPTED,
		.value_length = 0x02,
		.uuid = (uint8_t *)&qe_uuid45,
		.value = (uint8_t []){0x00,0x00},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 1,
		.p_write_cmd_cb = &(qe_write_cmd_cb_array[45])
	},
	// Descriptor: Characteristic User Description
	[46] =
	{
		...
		.uuid_length = QE_BLE_PROFILE_UUID_SIZE_ADOPTED,
		.value_length = 0x0C,
		.uuid = (uint8_t *)&qe_uuid46,
		.value = (uint8_t []){0x46,0x6C,0x6F,0x77,0x20,0x43,0x6F,0x6E,0x74,0x72,0x6F,0x6C},
		.notify_write = 0,
		.notify_read = 0,
		.read_indication = 0,
		.p_write_cmd_cb = &(qe_write_cmd_cb_array[46])
	}

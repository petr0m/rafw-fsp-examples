...
*******************************************************************************/
ble_status_t R_BLE_SPS_SERVICES_NotifySps_server_tx_data(uint16_t conn_hdl, const st_ble_sps_services_sps_server_tx_data_t *p_value);
 ...
 * @return    @ref ble_status_t
*******************************************************************************/
ble_status_t R_BLE_SPS_SERVICES_IndicateSps_server_tx_data(uint16_t conn_hdl, const st_ble_sps_services_sps_server_tx_data_t *p_value);
 ...
 * @return    @ref ble_status_t
*******************************************************************************/
ble_status_t R_BLE_SPS_SERVICES_SetSps_server_tx_dataCharUserDesc(const st_ble_sps_services_sps_server_tx_data_char_user_desc_t *p_value);
 ...
 * @return    @ref ble_status_t
*******************************************************************************/
ble_status_t R_BLE_SPS_SERVICES_GetSps_server_tx_dataCharUserDesc(st_ble_sps_services_sps_server_tx_data_char_user_desc_t *p_value);
 ...
 * @return    @ref ble_status_t
*******************************************************************************/
ble_status_t R_BLE_SPS_SERVICES_SetSps_server_rx_dataCharUserDesc(const st_ble_sps_services_sps_server_rx_data_char_user_desc_t *p_value);
 ...
 * @return    @ref ble_status_t
*******************************************************************************/
ble_status_t R_BLE_SPS_SERVICES_GetSps_server_rx_dataCharUserDesc(st_ble_sps_services_sps_server_rx_data_char_user_desc_t *p_value);
 ...
 * @return    @ref ble_status_t
*******************************************************************************/
ble_status_t R_BLE_SPS_SERVICES_SetSps_flow_ctrlCharUserDesc(const st_ble_sps_services_sps_flow_ctrl_char_user_desc_t *p_value);
 ...
 * @return    @ref ble_status_t
*******************************************************************************/
ble_status_t R_BLE_SPS_SERVICES_GetSps_flow_ctrlCharUserDesc(st_ble_sps_services_sps_flow_ctrl_char_user_desc_t *p_value);
...
typedef enum {
    /* Server TX Data */
    BLE_SPS_SERVICES_EVENT_SPS_SERVER_TX_DATA_HDL_VAL_CNF = BLE_SERVS_ATTR_EVENT(BLE_SPS_SERVICES_SPS_SERVER_TX_DATA_IDX, BLE_SERVS_HDL_VAL_CNF),
    BLE_SPS_SERVICES_EVENT_SPS_SERVER_TX_DATA_CLI_CNFG_WRITE_REQ = BLE_SERVS_ATTR_EVENT(BLE_SPS_SERVICES_SPS_SERVER_TX_DATA_CLI_CNFG_IDX, BLE_SERVS_WRITE_REQ),
    BLE_SPS_SERVICES_EVENT_SPS_SERVER_TX_DATA_CLI_CNFG_WRITE_COMP = BLE_SERVS_ATTR_EVENT(BLE_SPS_SERVICES_SPS_SERVER_TX_DATA_CLI_CNFG_IDX, BLE_SERVS_WRITE_COMP),
    BLE_SPS_SERVICES_EVENT_SPS_SERVER_TX_DATA_CLI_CNFG_READ_REQ = BLE_SERVS_ATTR_EVENT(BLE_SPS_SERVICES_SPS_SERVER_TX_DATA_CLI_CNFG_IDX, BLE_SERVS_READ_REQ),
    BLE_SPS_SERVICES_EVENT_SPS_SERVER_TX_DATA_CHAR_USER_DESC_READ_REQ = BLE_SERVS_ATTR_EVENT(BLE_SPS_SERVICES_SPS_SERVER_TX_DATA_CHAR_USER_DESC_IDX, BLE_SERVS_READ_REQ),
    /* Server RX Data */
    BLE_SPS_SERVICES_EVENT_SPS_SERVER_RX_DATA_WRITE_REQ = BLE_SERVS_ATTR_EVENT(BLE_SPS_SERVICES_SPS_SERVER_RX_DATA_IDX, BLE_SERVS_WRITE_REQ),
    BLE_SPS_SERVICES_EVENT_SPS_SERVER_RX_DATA_WRITE_COMP = BLE_SERVS_ATTR_EVENT(BLE_SPS_SERVICES_SPS_SERVER_RX_DATA_IDX, BLE_SERVS_WRITE_COMP),
    BLE_SPS_SERVICES_EVENT_SPS_SERVER_RX_DATA_WRITE_CMD = BLE_SERVS_ATTR_EVENT(BLE_SPS_SERVICES_SPS_SERVER_RX_DATA_IDX, BLE_SERVS_WRITE_CMD),
    BLE_SPS_SERVICES_EVENT_SPS_SERVER_RX_DATA_CHAR_USER_DESC_READ_REQ = BLE_SERVS_ATTR_EVENT(BLE_SPS_SERVICES_SPS_SERVER_RX_DATA_CHAR_USER_DESC_IDX, BLE_SERVS_READ_REQ),
    /* Flow Control */
    BLE_SPS_SERVICES_EVENT_SPS_FLOW_CTRL_WRITE_CMD = BLE_SERVS_ATTR_EVENT(BLE_SPS_SERVICES_SPS_FLOW_CTRL_IDX, BLE_SERVS_WRITE_CMD),
    BLE_SPS_SERVICES_EVENT_SPS_FLOW_CTRL_READ_REQ = BLE_SERVS_ATTR_EVENT(BLE_SPS_SERVICES_SPS_FLOW_CTRL_IDX, BLE_SERVS_READ_REQ),
    BLE_SPS_SERVICES_EVENT_SPS_FLOW_CTRL_CLI_CNFG_WRITE_REQ = BLE_SERVS_ATTR_EVENT(BLE_SPS_SERVICES_SPS_FLOW_CTRL_CLI_CNFG_IDX, BLE_SERVS_WRITE_REQ),
    BLE_SPS_SERVICES_EVENT_SPS_FLOW_CTRL_CLI_CNFG_WRITE_COMP = BLE_SERVS_ATTR_EVENT(BLE_SPS_SERVICES_SPS_FLOW_CTRL_CLI_CNFG_IDX, BLE_SERVS_WRITE_COMP),
    BLE_SPS_SERVICES_EVENT_SPS_FLOW_CTRL_CLI_CNFG_READ_REQ = BLE_SERVS_ATTR_EVENT(BLE_SPS_SERVICES_SPS_FLOW_CTRL_CLI_CNFG_IDX, BLE_SERVS_READ_REQ),
    BLE_SPS_SERVICES_EVENT_SPS_FLOW_CTRL_CHAR_USER_DESC_READ_REQ = BLE_SERVS_ATTR_EVENT(BLE_SPS_SERVICES_SPS_FLOW_CTRL_CHAR_USER_DESC_IDX, BLE_SERVS_READ_REQ),

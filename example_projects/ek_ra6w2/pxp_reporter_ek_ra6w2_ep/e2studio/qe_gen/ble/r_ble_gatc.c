...
static ble_status_t decode_st_ble_gatc_serv_chged_t(st_ble_gatc_serv_chged_t *p_app_value, const st_ble_gatt_value_t *p_gatt_value)
{
...
static ble_status_t encode_st_ble_gatc_serv_chged_t(const st_ble_gatc_serv_chged_t *p_app_value, st_ble_gatt_value_t *p_gatt_value)
{

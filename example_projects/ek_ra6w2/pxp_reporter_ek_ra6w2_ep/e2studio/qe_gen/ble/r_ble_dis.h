...
typedef enum {
    ...
    BLE_DIS_EVENT_MFR_NAME_WRITE_REQ = BLE_SERVS_ATTR_EVENT(BLE_DIS_MFR_NAME_IDX, BLE_SERVS_WRITE_REQ),
    BLE_DIS_EVENT_MFR_NAME_WRITE_COMP = BLE_SERVS_ATTR_EVENT(BLE_DIS_MFR_NAME_IDX, BLE_SERVS_WRITE_COMP),

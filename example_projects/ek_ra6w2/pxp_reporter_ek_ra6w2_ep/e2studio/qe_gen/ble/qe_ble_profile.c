...
const attribute_t qe_ble_profile[QE_ATTRIBUTE_HANDLE_PROFILE_END] =
{
	...
	[9] =
	{
		...
		.value = (uint8_t []){0x20,0x0A,0x00,0x05,0x2A},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[13] =
	{
		...
		.value = (uint8_t []){0x0A,0x0E,0x00,0x29,0x2A},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[14] =
	{
		...
		.value = (uint8_t []){0x52,0x65,0x6E,0x65,0x73,0x61,0x73,0x20,0x70,0x78,0x70,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
		.notify_write = 0,
		.notify_read = 0,
		.read_indication = 0,
	...
	[15] =
	{
		...
		.value = (uint8_t []){0x02,0x10,0x00,0x24,0x2A},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[17] =
	{
		...
		.value = (uint8_t []){0x02,0x12,0x00,0x25,0x2A},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[19] =
	{
		...
		.value = (uint8_t []){0x02,0x14,0x00,0x27,0x2A},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[21] =
	{
		...
		.value = (uint8_t []){0x02,0x16,0x00,0x26,0x2A},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[23] =
	{
		...
		.value = (uint8_t []){0x02,0x18,0x00,0x28,0x2A},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[25] =
	{
		...
		.value = (uint8_t []){0x02,0x1A,0x00,0x23,0x2A},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[27] =
	{
		...
		.value = (uint8_t []){0x02,0x1C,0x00,0x2A,0x2A},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[29] =
	{
		...
		.value = (uint8_t []){0x02,0x1E,0x00,0x50,0x2A},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[32] =
	{
		...
		.value = (uint8_t []){0x04,0x21,0x00,0x06,0x2A},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
	...
	[35] =
	{
		...
		.uuid_length = QE_BLE_PROFILE_UUID_SIZE_ADOPTED,
		.value_length = 0x05,
		.uuid = (uint8_t *)&qe_uuid35,
		.value = (uint8_t []){0x0A,0x24,0x00,0x06,0x2A},
		.notify_write = 0,
		.notify_read = 0,
		.read_indication = 0,
		.p_write_cmd_cb = &(qe_write_cmd_cb_array[35])
	},
	// Characteristic Value: Alert Level
	[36] =
	{
		...
		.uuid_length = QE_BLE_PROFILE_UUID_SIZE_ADOPTED,
		.value_length = 0x01,
		.uuid = (uint8_t *)&qe_uuid36,
		.value = (uint8_t []){0x00},
		.notify_write = 0,
		.notify_read = 1,
		.read_indication = 0,
		.p_write_cmd_cb = &(qe_write_cmd_cb_array[36])
	},
	...
	[37] =
	{
		...
		.uuid_length = QE_BLE_PROFILE_UUID_SIZE_ADOPTED,
		.value_length = 0x02,
		.uuid = (uint8_t *)&qe_uuid37,
		.value = (uint8_t *)&qe_value37,
		.notify_write = 0,
		.notify_read = 1,
		.read_indication = 0,
		.p_write_cmd_cb = &(qe_write_cmd_cb_array[37])
	},
	...
	[38] =
	{
		...
		.uuid_length = QE_BLE_PROFILE_UUID_SIZE_ADOPTED,
		.value_length = 0x05,
		.uuid = (uint8_t *)&qe_uuid38,
		.value = (uint8_t []){0x02,0x27,0x00,0x07,0x2A},
		.notify_write = 0,
		.notify_read = 0,
		.read_indication = 0,
		.p_write_cmd_cb = &(qe_write_cmd_cb_array[38])
	},
	...
	[39] =
	{
		...
		.uuid_length = QE_BLE_PROFILE_UUID_SIZE_ADOPTED,
		.value_length = 0x01,
		.uuid = (uint8_t *)&qe_uuid39,
		.value = (uint8_t []){0x00},
		.notify_write = 0,
		.notify_read = 1,
		.read_indication = 0,
		.p_write_cmd_cb = &(qe_write_cmd_cb_array[39])
	},
	// Service Declaration: Battery Service
	[40] =
	{
		.handle = 40,
		.encapsulated_attributes = 5,
		.permissions = 0x01,
		.uuid_length = QE_BLE_PROFILE_UUID_SIZE_ADOPTED,
		.value_length = 0x02,
		.uuid = (uint8_t *)&qe_uuid40,
		.value = (uint8_t *)&qe_value40,
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
		.p_write_cmd_cb = &(qe_write_cmd_cb_array[40])
	},
	...
	[41] =
	{
		...
		.uuid_length = QE_BLE_PROFILE_UUID_SIZE_ADOPTED,
		.value_length = 0x05,
		.uuid = (uint8_t *)&qe_uuid41,
		.value = (uint8_t []){0x12,0x2A,0x00,0x19,0x2A},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
		.p_write_cmd_cb = &(qe_write_cmd_cb_array[41])
	},
	...
	[42] =
	{
		...
		.uuid_length = QE_BLE_PROFILE_UUID_SIZE_ADOPTED,
		.value_length = 0x01,
		.uuid = (uint8_t *)&qe_uuid42,
		.value = (uint8_t []){0x00},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
		.p_write_cmd_cb = &(qe_write_cmd_cb_array[42])
	},
	// Descriptor: Client Characteristic Configuration
	[43] =
	{
		...
		.uuid_length = QE_BLE_PROFILE_UUID_SIZE_ADOPTED,
		.value_length = 0x02,
		.uuid = (uint8_t *)&qe_uuid43,
		.value = (uint8_t []){0x00,0x00},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 1,
		.p_write_cmd_cb = &(qe_write_cmd_cb_array[43])
	},
	...
	[44] =
	{
		...
		.uuid_length = QE_BLE_PROFILE_UUID_SIZE_ADOPTED,
		.value_length = 0x07,
		.uuid = (uint8_t *)&qe_uuid44,
		.value = (uint8_t []){0x00,0x00,0x00,0x00,0x00,0x00,0x00},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
		.p_write_cmd_cb = &(qe_write_cmd_cb_array[44])
	}

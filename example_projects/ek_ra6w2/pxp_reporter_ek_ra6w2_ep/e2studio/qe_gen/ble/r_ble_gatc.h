...
typedef enum {
    ...
    BLE_GATC_EVENT_SERV_CHGED_CLI_CNFG_READ_RSP = BLE_SERVC_ATTR_EVENT(BLE_GATC_SERV_CHGED_CLI_CNFG_IDX, BLE_SERVC_READ_RSP),
    BLE_GATC_EVENT_SERV_CHGED_CLI_CNFG_WRITE_RSP = BLE_SERVC_ATTR_EVENT(BLE_GATC_SERV_CHGED_CLI_CNFG_IDX, BLE_SERVC_WRITE_RSP),
} e_ble_gatc_event_t;

...
1. Project Overview:
This example project demonstrates the BLE proximity reporter, the application and profiles are controlled by RA6W2 
...
6) Start scan in Smart bond APP on the mobile phone, check the PXP-RA6W2 in the list
7) Connect to the PXP-RA6W2

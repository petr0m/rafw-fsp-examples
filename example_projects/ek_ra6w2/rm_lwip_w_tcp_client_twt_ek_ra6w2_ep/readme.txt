...
Example: rm_lwip_w_tcp_client_twt_ek_ra6w2_ep : TCP Client with DPM and TWT Mode Usage

1. Project Overview:
The rm_lwip_w_tcp_client_twt_ek_ra6w2_ep application acts as a TCP client in DPM mode and 

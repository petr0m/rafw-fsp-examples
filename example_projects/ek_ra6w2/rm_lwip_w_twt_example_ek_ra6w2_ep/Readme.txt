...
The rm_lwip_w_twt_example_ek_ra6w2_ep is a basic TWT application. After connecting to access point, it initiates a TWT session negotiation with defined wake intervals and durations.
